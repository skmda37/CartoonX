...
## Description   
This repsitory provides an implementation of CartoonX, an explanation method for image classifiers that we introduce in our paper [Cartoon Explanation of Image Classifiers](https://arxiv.org/abs/2110.03485), which was accepted as an oral presentation at ECCV 2022. CartoonX extracts the relevant piece-wise smooth part of an image and provides cartoon-like explanations. We provide a package with an implementation of CartoonX and a jupyter notebook demonstrating its usage with examples.
